export const translations = {
  en: {
    ...
    logsStatus: "Status",
    logsInputTokens: "Input",
    logsOutputTokens: "Output",
    logsTokens: "Input / Output",
    logsCompute: "Compute",
    logsCachedTokens: "Cached",
    logsLatency: "Latency",
    ...
    upstreamBreakdown: "Upstream Breakdown",
    upstreamBreakdownEmpty: "No direct-upstream usage has been recorded yet.",
  ...
  zh: {
    ...
    activeAccounts: "活跃账号",
    upstreamBreakdown: "上游拆分统计",
    upstreamBreakdownEmpty: "暂时没有直连上游用量记录。",
    upstreamName: "上游",
    upstreamProvider: "Provider",
